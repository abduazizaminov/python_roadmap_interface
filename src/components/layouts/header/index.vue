<template>
  <div class="w-full select-none bg-[#ECEFF1]">
    <div class="lg:max-w-7xl w-full ml-auto mr-auto">
      ...
      <router-link to="/">
        <li class="cursor-pointer duration-200 hover:text-customGreen font-medium leading-[155%] mr-[18px]">Саҳифаи асоси</li>
      </router-link>
      <router-link to="/roadmap">
        <li class="cursor-pointer duration-200 hover:text-customGreen font-medium leading-[155%] mx-[18px]">Саҳифаи Python Roadmap</li>
      </router-link>
