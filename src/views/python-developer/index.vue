            ...
            <div class="z-50 ">
              ...
              <div class="mt-[60px] font-ibm mb-[32px] flex">
                <router-link to="/roadmap">
                  <div
                    class="cursor-pointer border-solid rounded-[10px] mr-[10px] border-black border-[3px] px-[44px] py-[22px] text-[16px] leading-[155%] font-semibold">
                    Python Roadmap
                  </div>
                </router-link>
              </div>
              ...
              <div class="flex font-ibm text-white text-[14px]">
                <div @click="goToPythonDevInfo()" class="bg-black rounded-[10px] cursor-pointer col-span-6 px-[14px] py-[5px]">
                  Python - таҳиягар кист
                </div>
              </div>
            </div>
            <div class="block">
              <div class="w-[460px] h-[460px] rotate-45 spin-block border-[1px] border-[#FDD231]">
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="lg:max-w-7xl mb-16 w-full ml-auto mr-auto">
      ...
      <div id="dev" class="lg:px-16 md:px-8 px-6 py-10">
        ...
        <div class="flex items-center">
          ...
          <div class="mt-[-50px]">
            <div class="bg-[#FEC] w-[520px] h-[520px] rounded-full flex justify-center items-center bg-opacity-20">
      ...
      <div class="lg:px-16 md:px-8 px-6 py-10">
        ...
        <div class="grid grid-cols-12 gap-[30px]">
          <div class="lg:col-span-4 md:col-span-6 col-span-12">
            <job-info-block>
              Барномасозиро дар Python азхуд кунед 
              ва мушкилотро дар истифодаи
